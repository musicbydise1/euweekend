            ...
            <div class="steps-grid">
                ...
                <div class="step-card">
                    ...
                    <div class="step-card-body">
                        <h1>Учащиеся размещаются в студенческой резиденции The Myriad.</h1>
                        <p>Это современное, новое студенческое общежитие
                            с комфортными двухместными номера со всеми удобствами.</p>
                    </div>
                </div>
                ...
                <div class="step-card">
                    ...
                    <div class="step-card-body">
                        <h1>Безопасность и вдохновляющая атмосфера — главные особенности резиденции.</h1>
                        <p>Это современное, новое студенческое общежитие
                            с комфортными двухместными номера со всеми удобствами.</p>
                    </div>
                </div>
                ...
                <div class="step-card">
                    ...
                    <div class="step-card-body">
                        <h1>Проживание в лагере исключительно в двухместных номерах.</h1>
                        <p>Это современное, новое студенческое общежитие
                            с комфортными двухместными номера со всеми удобствами.</p>
                    </div>
                </div>
                ...
                <div class="step-card">
                    ...
                    <div class="step-card-body">
                        ...
                        <p>Договор будет вам выслан по электронной почте.</p>
                    </div>
                </div>
                ...
                <div class="step-card">
                    ...
                    <div class="step-card-body">
                        <h1>Подготовка документов на визу</h1>
                        <p>Консультации по сбору пакета документов для получения визы,
                            помощь в заполнении анкет для посольства.</p>
                    </div>
                </div>

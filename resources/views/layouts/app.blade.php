...
<!-- Навигация (без фиксированного позиционирования по умолчанию) -->
<header class="header-nav">
    <div class="container nav-inner">
        <div class="logo">
            <a href="{{ route('home') }}">
                <img src="{{ asset('images/logo.svg') }}" alt="Site Logo" class="default-logo">
        ...
        <div class="nav-extra">
            <div class="phone-info">
                <img src="{{ asset('images/icons/phone-icon.svg') }}" alt="Phone Icon" class="phone-icon default-logo">
